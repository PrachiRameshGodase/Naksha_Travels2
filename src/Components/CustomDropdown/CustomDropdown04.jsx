  ...
  return (
    <div
      data-tooltip-content={
        item_data?.type === "Service" && name === "unit_id"
          ? "Unit is not changed for service type select"
          : item_data?.type !== "" &&
            name == "type" &&
            (item_data?.item_id || item_data?.is_service == 1)
          ? "Selected type is not changed"
          : disabled
    ...
    >
      <div
        ...
        style={{
          cursor:
            (item_data?.type === "Service" && name === "unit_id") ||
            (item_data?.type !== "" && name === "type" && item_data?.item_id) ||
            disabled
              ? "not-allowed"
              : "pointer",
        }}
      >
        ...
        type === "item_type" ? (
          ...
          <>
            {value
              ? options?.find((account) => account?.labelid == value)?.label
              : defaultOption}
          </>
        )}
...
export const CustomDropdown004 = forwardRef((props, ref) => {
  ...
  return (
    <div
      data-tooltip-content={
        item_data == "1" ? "Tax has already been applied to purchases." : ""
      }
      data-tooltip-id="my-tooltip"
      data-tooltip-place="bottom"
      // show tool tip of related message if any type is selected or unit is service selected in item select module
    ...
    >
      ...
      >
        ...
        {tax_rate == 0 || tax_rate === null
          ? defaultOption
          : options?.find((account) => account?.tax_percentge === value)
              ?.tax_percentge || value}
...
export const CustomDropdown0004 = forwardRef((props, ref) => {
  let {
    options,
    value,
    onChange,
      ...
      data-tooltip-content={
        item_data?.type === "Service" && name === "unit_id"
          ...
          : item_data?.type !== "" &&
            ...
            (item_data?.item_id || item_data?.is_service == 1)
          ? "Selected type is not changed"
         :disabled ?"Please Select Package"
