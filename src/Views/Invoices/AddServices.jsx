...
const AddServices = ({ formData, setFormData, handleChange,
    note,
}) => {
            ...
            <div className="f1wrpofcreqsx2" id={""}>
                <div className="itemsectionrows">
                    ...
                    {formData?.items?.length > 0 ?
                                ...
                                <div className="table_item_border">
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            style={{ cursor: "not-allowed", marginTop: "10px", width: "47px" }}
                                        >
                                            {item?.final_amount}
                                        </div>
                        ...
                        <div class="empty_data_services_messs">Please Select the Services.</div>
                    }
