...
const CreateSalesOrders = () => {
  ...
  useEffect(() => {
    if (itemId && isEdit) {
      ...
      itemId &&
      (convert === "toInvoice" || convert === "quotationToSale")
    ) {
  ...
  useEffect(() => {
    if ((itemId && isEdit && fetchDetails) || (itemId && convert)) {
      ...
      setFormData({
        ...
        display_name:
          fetchDetails?.display_name == "0" ? "" : fetchDetails?.display_name,
        ...
        delivery_method:
          fetchDetails?.delivery_method == "0"
            ? ""
            : fetchDetails?.delivery_method,
        sale_person:
        ...
        shipment_date: convert
          ? fetchDetails?.expiry_date
          : fetchDetails?.shipment_date,
      ...
      if (fetchDetails?.address) {
        const parsedAddress = fetchDetails?.address
          ? JSON.parse(fetchDetails?.address)
          : [];
  ...
  return (
    <>
      {saleDetail?.loading === true || quoteDetail?.loading === true ? (
        <Loader02 />
      ) : (
        <>
          {(quoteCreate?.loading ||
            ...
            <div id="Anotherbox" className="formsectionx2">
              <div id="leftareax12">
                <h1 id="firstheading">
                  ...
                  >
                    <path
                      d="m8.6 20h23.33l16.28 8.63-3.63 11.91a2.4 2.4 0 0 1 -2.17 1.7l-29.58 1.55z"
                      fill="#d5e4ef"
                    ></path>
                    <circle cx="19" cy="55" fill="#262a33" r="4"></circle>
                    <circle cx="37" cy="55" fill="#262a33" r="4"></circle>
                    <circle cx="45" cy="15" fill="#19cc61" r="14"></circle>
                    <path
                      d="m29 28h-13a1 1 0 0 1 0-2h13a1 1 0 0 1 0 2z"
                      fill="#b9c9d6"
                    ></path>
                    <path
                      d="m40 36h-23a1 1 0 0 1 0-2h23a1 1 0 0 1 0 2z"
                      fill="#b9c9d6"
                    ></path>
                    <path
                      d="m43 22a1 1 0 0 1 -.707-.293l-4-4a1 1 0 0 1 1.414-1.414l3.138 3.138 7.323-10.986a1 1 0 1 1 1.664 1.11l-8 12a1 1 0 0 1 -.732.445c-.035 0-.068 0-.1 0z"
                      fill="#fff"
                    ></path>
                    <path
                      d="m44 52-31.756-.007a3.24 3.24 0 0 1 -2.744-4.958l2.314-3.514c-.185-.777-.409-2.031-.768-4.051l-4.185-23.47h-5.861a1 1 0 0 1 0-2h6.7a1 1 0 0 1 .985.824s5.081 28.529 5.128 28.788a1.008 1.008 0 0 1 -.149.731l-2.484 3.772a1.241 1.241 0 0 0 1.065 1.878l31.755.007a1 1 0 0 1 0 2z"
                      fill="#b9c9d6"
                    ></path>
                  </svg>
                  ...
                  <div className="itemsformwrap">
                    <div className="f1wrapofcreq">
                      ...
                      <div className="f1wrapofcreqx1">
                        <div className="form_commonblock">
                          <label>
                            Sales Order<b className="color_red">*</b>
                          </label>
                          <GenerateAutoId
                            formHandlers={{
                              setFormData,
