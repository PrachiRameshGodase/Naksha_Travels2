    ...
    <>
      ...
      <div className="formsectionsgrheigh">
        ...
        <div style={{ width: "100%" }} className="col-md-12">
          <div
            className="ccfz1 formsectionx1 col-md-3"
            style={{
              width: "20%",
              float: "left",
              borderRight: "2px solid #5d369f91",
            }}
          >
            <div
              className="insideccfz1 "
