...
import { activeCustomerData, activeOrg_details, getCurrencyFormData, parseJSONofString, ShowMasterData, showRealatedText, stringifyJSON } from '../../Helper/HelperFunctions';
    ...
    useEffect(() => {
        if ((itemId && isEdit && fetchDetails) || (itemId && isDuplicate && fetchDetails) || (itemId && convert && fetchDetails)) {
            ...
            const calculateTotalGrossAmount = () => {
                return fetchDetails?.items?.reduce((total, entry) => {
                    return total + (parseFloat(entry?.gross_amount) ? parseFloat(entry?.gross_amount) : 0);
                }, 0);
            };
                                ...
                                <div className="itemsformwrap">
                                    <div className="f1wrapofcreq">
                                        ...
                                        <div className="f1wrapofcreqx1">
                                            ...
                                            {console.log("formData?.value id", formData?.invoice_id)
                                            }
                                            <div className="form_commonblock">
