...
import { materialRequisitionsDetails } from '../../Redux/Actions/manufacturingActions';
import { RequisitionDetailsBox } from '../Items/InsideItemDetailsBox';
...
const ItemDetails = () => {
    ...
    const requisitionDetails = useSelector(state => state?.requisitionDetail);
    const requisitionDetail = requisitionDetails?.data?.data?.requisition;
    ...
    useEffect(() => {
        if (itemId) {
            const queryParams = {
                requestion_id: itemId,
            };
            dispatch(materialRequisitionsDetails(queryParams));
        }
    }, [dispatch, itemId]);
            ...
            <Toaster />
            {
                item_detail?.loading ? <Loader02 /> :
                    ...
                    <>
                        <div id="Anotherbox" className='formsectionx3'>
                            <div id="leftareax12">
                                <h1 className='' id="firstheading">
                                    {requisitionDetail?.requestion_id}
                                </h1>
                            ...
                            <div id="buttonsdata">
                                ...
                                <Link className="linkx4" to={"/dashboard/requisition"}>
                                    <RxCross2 />
                                </Link>
                            </div>
                        </div>
                        ...
                        <div id="item-details">
                            <RequisitionDetailsBox itemDetails={requisitionDetail} preferred_vendor={preferred_vendor} warehouseData={warehouseData} />
                        </div>
