...
import { warehouseViewAction, zoneCreateAction, zoneDetailAction } from '../../../Redux/Actions/warehouseActions';
...
const CreateZone = () => {
    ...
    const zoneDetails = useSelector(state => state?.zoneDetail || {});
    const zoneView = zoneDetails?.data?.data;
                ...
                <div id="Anotherbox" className='formsectionx2'>
                    <div id="leftareax12">
                        <h1 id="firstheading">
                            ...
                            {isEdit ? "Update" : "New"} Zone / Container
                        </h1><br /><br /><br /><br />

                    </div>
                    <div id="buttonsdata">
                        <Link to={"/dashboard/zone"} className="linkx3">
                            <RxCross2 />
                        </Link>
                    </div>
                </div>
                ...
                <div id="formofcreateitems" >
                    <DisableEnterSubmitForm onSubmit={handleFormSubmit}>
                        <div className="relateivdiv">
                            ...
                            <div className="itemsformwrap">
                                <div className="f1wrapofcreq" style={{ paddingBottom: "31vh" }}>
                                    ...
                                    <div className="f1wrapofcreqx1">
                                        ...
                                        <div className="form_commonblock"
                                            data-tooltip-content="Changed Onle When Select Warehouse"
                                            data-tooltip-id="my-tooltip"
                                            data-tooltip-place="bottom">
                                            <label className='color_red'>Zone Type</label>
                                            <span >
                                                {otherIcons.placeofsupply_svg}
                                                <p className='zone_x_09'>
                                                    <ShowMastersValue type="22" id={formData.zone_type} />
                                                </p>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <SubmitButton2 isEdit={isEdit} itemId={itemId} cancel="zone" />
