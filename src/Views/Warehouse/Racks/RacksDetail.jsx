...
const RacksDetail = () => {
    ...
    const item_detail = useSelector(state => state?.rackDetail);
                    ...
                    <>
                        <div id="Anotherbox" className='formsectionx1'>
                            ...
                            <div id="buttonsdata">
                                ...
                                <Link to={"/dashboard/racks"} className="linkx3" data-tooltip-place='bottom' data-tooltip-id="my-tooltip" data-tooltip-content="Close" >
                                    <RxCross2 />
                                </Link>
                            </div>
                        </div>
